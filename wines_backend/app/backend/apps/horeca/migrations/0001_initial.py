    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='horeca_wine', to='wine.wine')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='horeca',
            name='wines',
            field=models.ManyToManyField(blank=True, related_name='wines', through='horeca.HorecaWine', to='wine.Wine'),
        ),
        migrations.CreateModel(
